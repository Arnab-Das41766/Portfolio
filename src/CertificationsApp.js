...
// For each cert:
// - file: path inside /certifications/ folder (e.g. 'aws_cloud.pdf' or 'coursera_ml.jpg')
// - Leave file as null if you don't have a digital copy yet
const CERTIFICATIONS = [
  {
    ...
    icon: '🏆',
    color: '#f59e0b',
    description: 'Place your certification files in public/certifications/ and update this list in CertificationsApp.js to show them here.',
    file: null,
    credentialUrl: null,
  },
]
